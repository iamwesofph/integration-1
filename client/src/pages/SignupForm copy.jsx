    ...
    return (
        <>
            ...
            <div className="flex justify-evenly items-center p-4">
                        ...
                        <div className="rounded-md absolute bottom-8 translate-y-full" role="menu">
                            <div className="rounded-md flex flex-col items-start border border-gray-500 bg-gray-800 overflow-hidden">
                                <label htmlFor="upload_photo" className="select-none whitespace-nowrap text-sm cursor-pointer w-full text-left px-4 py-2 hover:bg-cyan-400 hover:text-slate-700" tabIndex="1">
                                    Upload a photo…
                                    <input className="hidden" type="file" id="upload_photo" accept="image/*" onChange={handleImageUpload} />
                                </label>
                                {selectedImage && (
                                ...
                                {/* <button className="whitespace-nowrap text-sm cursor-pointer w-full text-left px-4 py-2 hover:bg-cyan-400 hover:text-slate-700">Upload a photo...</button>
                                <button className="whitespace-nowrap text-sm cursor-pointer w-full text-left px-4 py-2 hover:bg-cyan-400 hover:text-slate-700" onClick={() => setSelectedImage(null)}>
                                    Remove photo
                                </button> */}
                            </div>
                        </div>
                ...
                <form className="sm:w-[400px]" onSubmit={handleSubmit} enctype="multipart/form-data">
                    <label>
